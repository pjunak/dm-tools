"""Scientifically designed colour tables used by terrain renderers."""

from __future__ import annotations

import numpy as np

# Land half (entries 128-255) of Fabio Crameri's ``oleron`` surface-topography
# colour map from Scientific Colour Maps 8.0. The original table is MIT licensed;
# see docs/DEPENDENCIES.md for source and attribution.
OLERON_LAND_RGB = np.array(
    [
