...
height points plus ridge and valley centrelines, generate a deterministic
constraint-conditioned elevation field, preview it as colour relief, and export
the preview as a transparent PNG.
